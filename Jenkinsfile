    ...
    podTemplate(label: label, serviceAccount: 'jenkins',
            ...
            containerTemplate(name: 'semantic-release', image: 'esmartit/semantic-release:1.0.1', ttyEnabled: true, command: 'cat',envVars: [envVar(key: 'GITHUB_TOKEN', value: 'esmartit')])
            ]
    ) {
